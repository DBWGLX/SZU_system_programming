...
void sendMessage(int sockfd, UserInfo *user_info) {
    ...
    while (running) {
        ...
        if (command == "/quit" || command == "/q") {
            ...
            msg.set_type(5000);
            msg.set_account(current_account);
            msg.set_token(current_token.c_str());
            ...
            msg.set_account(current_account);
            msg.set_token(current_token);
            msg.set_receiver_useraccount(receiver);
