...
#define FIFO_NAME "/home/szu/wangyaxian2022150054/chatapplication/data/server_fifo/chat_serve_fifo"
#define BUFF_SZ 100
...
int main(int argc, char* argv[]) {
        ...
        if (argc != 4) {
            printf("Usage : %s op1 operation op 2\n", argv[0]);
            exit(1);
        }
        ...
        /*create my own FIFO */
        sprintf(mypipename, "/home/szu/wangyaxian2022150054/chatapplication/data/client_fifo/chat_client%d_fifo", getpid()); 
